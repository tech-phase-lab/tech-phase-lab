...
test("calendar coverage tracks 40 unique companies and only conclusive checks advance", () => {
  ...
  for (const ticker of ["AAPL", "AMZN", "ANET", "ARM", "AVGO", "BE", "COHR", "CRDO", "CRM", "CRWV", "GOOGL", "KLAC", "LITE", "MRVL", "ORCL", "PANW", "PLTR", "SKHY", "SNOW", "VRT"]) assert.equal(byTicker[ticker].lastAttemptedOn, "2026-09-25");
  for (const ticker of ["NBIS", "NOW", "NVDA"]) assert.equal(byTicker[ticker].lastAttemptedOn, "2026-09-24");
