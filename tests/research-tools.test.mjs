...
test("calendar coverage tracks 40 unique companies and only conclusive checks advance", () => {
  ...
  assert.ok(coverage.every((company) => /^2026-09-2[23]$/.test(company.lastAttemptedOn)));
  ...
  for (const ticker of ["AAPL", "AMZN", "ANET", "ARM", "AVGO", "BE", "COHR", "CRDO", "CRM", "CRWV", "GOOGL", "KLAC", "LITE", "MRVL", "NBIS", "NOW", "NVDA", "ORCL", "PANW", "PLTR", "SKHY", "SNOW", "VRT"]) assert.equal(byTicker[ticker].lastAttemptedOn, "2026-09-23");
