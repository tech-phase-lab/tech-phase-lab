...
test("calendar coverage tracks 40 unique companies and only conclusive checks advance", () => {
  ...
  for (const ticker of ["AAPL", "AMZN", "ANET", "ARM", "AVGO", "BE", "COHR", "CRDO", "CRM", "CRWV", "GOOGL", "KLAC", "LITE", "NVDA", "ORCL", "PANW", "PLTR", "SKHY", "SNOW", "VRT"]) assert.equal(byTicker[ticker].lastAttemptedOn, "2026-09-26");
  for (const ticker of ["MRVL", "NBIS", "NOW"]) assert.equal(byTicker[ticker].lastAttemptedOn, "2026-09-25");
