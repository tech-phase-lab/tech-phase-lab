...
class CoverageReportTests(unittest.TestCase):
    def test_configuration_only_does_not_claim_live_coverage(self):
        ...
        pltr = next(c for c in result['companies'] if c['ticker'] == 'PLTR')
        self.assertIn('palantir-shareholder-letters', pltr['dedicatedSupplementalSources'])
        self.assertFalse(pltr['needsDedicatedSupplementalSource'])
